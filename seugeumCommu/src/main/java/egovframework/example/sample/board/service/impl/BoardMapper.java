...
public interface BoardMapper {
	...
	// ------------------- 선아님 ----------------------
	List<?> selectBoardList2(BoardVO searchVO) throws Exception;

	// ------------------- 승수님 ----------------------
	List<?>selectBoardMain(BoardVO vo) throws Exception;
	
	List<?>selectBoardMain2(BoardVO vo) throws Exception;
