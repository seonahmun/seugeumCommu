...
<script type="text/javaScript" language="javascript" defer="defer">
   ...
   function joinCheck(){
      console.log(joinBtnCheck);
      if(joinBtnCheck < 1){
         alert("회원가입 확인 버튼을 눌러서 가입 정보를 확인해주세요");
      } else if(passCheck < 1){
         alert("비밀번호 확인 버튼을 눌러서 비밀번호를 확인해주세요");
      } else if(nickCheck < 1){
         alert("닉네임 중복 확인 버튼을 눌러서 닉네임을 확인해주세요");
      } else {
          ...
          $.ajax({
            ...
            success: function(result){
               if (result == "ok") {
                  ...
                  joinBtnCheck++;
                  console.log("joinBtnCheck : " + joinBtnCheck);
               } else {
   ...
   <div class="container">
      ...
      <form name="formName" action="/joins.do" method="post">
         ...
         <div class="inputBox submitBox">
            <input type="submit" id="joinCheckBtn" onclick="joinCheck()" value="가입하기">
         </div>
      </form>
   </div>
</body>
